...
async function seed() {
  ...
  // =========================
  // Users: official clean-start staff accounts
  // No patient account
  // =========================
  const users = [
    // Admin
  ...
  await pool.query(
    ...
    VALUES
      (1, 1, 'Admin', 'Maryj', 'Ortega',
       'Admin', NULL, 'Administration', NULL,
       'Full-Time', 'Regular',
       'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday',
       '10:00:00', '19:00:00', 'Active'),

      (2, 1, 'Dentist', 'Twinky', 'Belino',
       'Dentist', 'Cosmetic Dentist', 'Cosmetic Dentistry', 'DMD',
       'Full-Time', 'Regular',
       'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday',
       '10:00:00', '19:00:00', 'Active'),

      (3, 1, 'Dentist', 'Maureen', 'Datu',
       'Dentist', 'Orthodontist', 'Orthodontics', 'DMD',
       'Full-Time', 'Regular',
       'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday',
       '10:00:00', '19:00:00', 'Active'),

      (4, 1, 'Dentist', 'Tourmand', 'Morteza',
       'Dentist', 'Endodontist', 'Endodontics', 'DMD',
       'Full-Time', 'Regular',
       'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday',
       '10:00:00', '19:00:00', 'Active'),

      (5, 1, 'Receptionist', 'Makati', 'Receptionist',
       'Receptionist', NULL, NULL, NULL,
       'Full-Time', 'Regular',
       'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday',
       '10:00:00', '19:00:00', 'Active'),

      (6, 2, 'Receptionist', 'Las Piñas', 'Receptionist',
       'Receptionist', NULL, NULL, NULL,
       'Full-Time', 'Regular',
       'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday',
       '10:00:00', '19:00:00', 'Active')
  ...
  await pool.query(
    ...
    VALUES
      ...
      ('Cosmetic Dentistry', 'Smile Make-overs', 90, 25000.00, 'Active',
      ...
      ('Cosmetic Dentistry', 'Veneers (Emax or Zirconia)', 90, 18000.00, 'Active',
      ...
      ('Prosthodontics', 'Complete & Removable Partial Dentures', 90, 15000.00, 'Active',
      ...
      ('Orthodontics', 'Orthodontics (Braces)', 60, 40000.00, 'Active',
  ...
  await pool.query(
    ...
    VALUES
      -- Dr. Twinky Belino - official cosmetic, cleaning, prosthodontic, aligner, and implant services
      (2, 1),
      (2, 2),
      (2, 3),
      (2, 4),
      ...
      -- Dr. Tourmand Morteza - Root Canal Treatment
      (4, 7),
  ...
  // Normalize the clean-start schedule after retiring old doctors from the seed.
  // Each current dentist has availability in both branches; appointment conflicts
  // still block the same dentist from being booked twice at the same time.
  await pool.query('DELETE FROM dentist_schedules');
  await pool.query(
    `
    INSERT INTO dentist_schedules (dentist_id, branch_id, weekday, start_time, end_time)
    VALUES
      (2, 1, 0, '10:00:00', '19:00:00'), (2, 2, 0, '10:00:00', '19:00:00'),
      (2, 1, 1, '10:00:00', '19:00:00'), (2, 2, 1, '10:00:00', '19:00:00'),
      (2, 1, 2, '10:00:00', '19:00:00'), (2, 2, 2, '10:00:00', '19:00:00'),
      (2, 1, 3, '10:00:00', '19:00:00'), (2, 2, 3, '10:00:00', '19:00:00'),
      (2, 1, 4, '10:00:00', '19:00:00'), (2, 2, 4, '10:00:00', '19:00:00'),
      (2, 1, 5, '10:00:00', '19:00:00'), (2, 2, 5, '10:00:00', '19:00:00'),
      (2, 1, 6, '10:00:00', '19:00:00'), (2, 2, 6, '10:00:00', '19:00:00'),

      (3, 1, 0, '10:00:00', '19:00:00'), (3, 2, 0, '10:00:00', '19:00:00'),
      (3, 1, 1, '10:00:00', '19:00:00'), (3, 2, 1, '10:00:00', '19:00:00'),
      (3, 1, 2, '10:00:00', '19:00:00'), (3, 2, 2, '10:00:00', '19:00:00'),
      (3, 1, 3, '10:00:00', '19:00:00'), (3, 2, 3, '10:00:00', '19:00:00'),
      (3, 1, 4, '10:00:00', '19:00:00'), (3, 2, 4, '10:00:00', '19:00:00'),
      (3, 1, 5, '10:00:00', '19:00:00'), (3, 2, 5, '10:00:00', '19:00:00'),
      (3, 1, 6, '10:00:00', '19:00:00'), (3, 2, 6, '10:00:00', '19:00:00'),

      (4, 1, 0, '10:00:00', '19:00:00'), (4, 2, 0, '10:00:00', '19:00:00'),
      (4, 1, 1, '10:00:00', '19:00:00'), (4, 2, 1, '10:00:00', '19:00:00'),
      (4, 1, 2, '10:00:00', '19:00:00'), (4, 2, 2, '10:00:00', '19:00:00'),
      (4, 1, 3, '10:00:00', '19:00:00'), (4, 2, 3, '10:00:00', '19:00:00'),
      (4, 1, 4, '10:00:00', '19:00:00'), (4, 2, 4, '10:00:00', '19:00:00'),
      (4, 1, 5, '10:00:00', '19:00:00'), (4, 2, 5, '10:00:00', '19:00:00'),
      (4, 1, 6, '10:00:00', '19:00:00'), (4, 2, 6, '10:00:00', '19:00:00')
    `
  );
  ...
  await pool.query(
    ...
    VALUES
      (1, 'Default materials and equipment for deep scaling.'),
      (2, 'Default materials for cosmetic smile make-over planning.'),
      (3, 'Default materials and equipment for teeth whitening.'),
      (4, 'Default materials for veneers preparation and placement.'),
      (5, 'Default materials for porcelain jacket crown preparation.'),
      (6, 'Default materials for complete or removable partial dentures.'),
      (7, 'Default materials and medicine for root canal treatment.'),
      (8, 'Default materials and equipment for braces installation or adjustment.'),
      (9, 'Default materials for clear aligner consultation and fitting.'),
  ...
  await pool.query(
    ...
    VALUES
      -- 1 Deep Scaling (Dental Cleaning)
      (1, 'supply', 'Scaling Tips', 1),
      (1, 'supply', 'Prophy Brush', 1),
      (1, 'medicine', 'Chlorhexidine Mouthwash', 1),
      (1, 'equipment', 'Ultrasonic Scaler', 1),

      -- 2 Smile Make-overs
      (2, 'supply', 'Shade Guide Card', 1),
      (2, 'supply', 'Composite Veneer Kit', 1),
      (2, 'equipment', 'Intraoral Camera', 1),

      -- 3 Teeth Whitening
      (3, 'supply', 'Whitening Gel Syringe', 1),
      (3, 'equipment', 'LED Teeth Whitening Lamp', 1),
      (3, 'medicine', 'Topical Anesthetic Gel', 1),

      -- 4 Veneers
      (4, 'supply', 'Composite Veneer Kit', 1),
      (4, 'supply', 'Shade Guide Card', 1),
      (4, 'medicine', 'Lidocaine Anesthetic', 1),

      -- 5 Porcelain Jacket Crowns
      (5, 'supply', 'Crown Impression Trays', 1),
      (5, 'equipment', 'Dental Lab Handpiece', 1),
      (5, 'medicine', 'Lidocaine Anesthetic', 1),

      -- 6 Complete & Removable Partial Dentures
      (6, 'supply', 'Denture Impression Material', 1),
      (6, 'supply', 'Crown Impression Trays', 1),
      (6, 'equipment', 'Dental Lab Handpiece', 1),

      -- 7 Root Canal Treatment
      (7, 'medicine', 'Lidocaine Anesthetic', 2),
      (7, 'medicine', 'Calcium Hydroxide Paste', 1),
      (7, 'medicine', 'Sodium Hypochlorite Solution', 1),
      (7, 'equipment', 'Root Canal Motor', 1),

      -- 8 Orthodontics (Braces)
      (8, 'supply', 'Orthodontic Brackets', 1),
      (8, 'supply', 'Orthodontic Archwires', 1),
      (8, 'supply', 'Elastic Ligature Ties', 1),
      (8, 'equipment', 'Orthodontic Pliers Set', 1),

      -- 9 Clear Aligners
      (9, 'supply', 'Clear Aligner Case', 1),
      (9, 'equipment', 'Intraoral Camera', 1),
  ...
  console.log('  twinky.belino@test.com     -> Dr. Twinky Belino, official cosmetic/cleaning/prosthodontic/aligner/implant services');
  console.log('  maureen.datu@test.com      -> Dr. Maureen Datu, Orthodontics (Braces)');
  ...
  console.log('');
  console.log('Retired doctor accounts are not seeded: adrian.santos@test.com, camille.reyes@test.com, nathan.cruz@test.com');
