const createDentistNotificationsStyles = ({
  ...
  return {
    ...
    sidebar: {
      ...
      padding: isTablet ? '16px 8px' : isMobile ? '18px 10px' : '22px 16px',
      zIndex: 200,
      display: 'flex',
    ...
    logo: {
      textAlign: 'center',
      paddingBottom: isTablet ? 16 : isMobile ? 18 : 22,
      marginBottom: isMobile ? 12 : 14,
      borderBottom: '1px solid #e5e7eb',
    },

    logoImg: {
      width: isTablet ? 46 : isMobile ? 54 : 125,
      height: 'auto',
    },
    ...
    menuItem: {
      ...
      gap: 12,
      padding: isTablet ? '13px 8px' : isMobile ? '14px 10px' : '13px 14px',
      borderRadius: 14,
      textDecoration: 'none',
      color: '#475569',
    ...
    menuItemIcon: {
      ...
      fontSize: isMobile && !isTablet ? 20 : 18,
    ...
    topHeader: {
      ...
      left: sidebarWidth,
      right: 0,
      height: isTablet || isMobile ? 76 : 86,
      background: '#ffffff',
      borderBottom: '1px solid #e5e7eb',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'flex-end',
      padding: isTablet ? '0 14px' : isMobile ? '0 18px' : '0 28px',
      zIndex: 150,
      boxSizing: 'border-box',
    },
    ...
    avatar: {
      width: isTablet ? 34 : 40,
      height: isTablet ? 34 : 40,
      borderRadius: isTablet ? 12 : 13,
      background: '#eff6ff',
      color: '#2563eb',
      display: 'flex',
      alignItems: 'center',
    ...
    heroTitle: {
      maxWidth: 760,
      fontSize: isTablet ? 20 : isMobile ? 22 : isSmallScreen ? 28 : 31,
      color: '#ffffff',
      marginBottom: 12,
      marginTop: 0,
    ...
    heroText: {
      ...
      marginBottom: 0,
      color: '#ffffff',
      fontSize: isTablet ? 12 : isMobile ? 13 : 14,
    ...
    notificationCard: {
      background: '#ffffff',
      border: '1px solid #edf0f5',
      borderRadius: isTablet ? 18 : isMobile ? 20 : 22,
      padding: isTablet ? 14 : isMobile ? 16 : 26,
      minHeight: 560,
      boxShadow: '0 8px 22px rgba(15, 23, 42, 0.04)',
      boxSizing: 'border-box',
    },
    ...
    notificationItem: {
      ...
      gap: 14,
      padding: isTablet ? 16 : isMobile ? 18 : 22,
    ...
    modalContent: {
      ...
      maxWidth: 380,
      background: '#ffffff',
      borderRadius: isTablet ? 20 : 22,
      padding: isTablet ? '24px 18px' : 30,
      textAlign: 'center',
