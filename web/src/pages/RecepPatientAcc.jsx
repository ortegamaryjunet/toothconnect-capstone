...
export default function RecepPatientAcc() {
  ...
  const filteredAccounts = useMemo(() => {
    ...
    return patientAccounts.filter((account) => {
      const searchData = `${account.infoId} ${account.name} ${account.contactNumber}`.toLowerCase();
  ...
  useEffect(() => {
    const hasOpenModal =
      showLogoutModal || showUpdateOverlay || showCreateOverlay;
  ...
  async function handleUpdateSubmit(event) {
    ...
    try {
      ...
      setUpdateErrors({
        form: err.response?.data?.message || 'Failed to update patient account.',
      });
    }
  }
                  ...
                  {pagedAccounts.length === 0 ? (
                    ...
                    pagedAccounts.map((account) => (
                      <tr key={account.infoId}>
                        ...
                        <td style={styles.td}>
                          <StatusBadge styles={styles} status={account.status} />
                        </td>
            ...
            <form style={styles.overlayBody} onSubmit={handleUpdateSubmit}>
              ...
              <div style={styles.formGrid}>
                ...
                <InputField
                  ...
                  onChange={(value) => handleUpdateChange('contactNumber', value)}
            ...
            <form style={styles.overlayBody} onSubmit={handleCreateSubmit}>
              ...
              <div style={styles.formGrid}>
                ...
                <InputField
                  ...
                  onChange={(value) => handleCreateChange('contactNumber', value)}
...
function mapPatientAccount(patient = {}) {
  ...
  return {
    ...
    deactivated: patient.deactivated_at ? formatDate(patient.deactivated_at) : '',
